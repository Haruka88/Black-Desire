...
switch (_shop) do
{
	case "market": {["Supermarkt",["water","redgull","tbacon","lockpick","pickaxe","fuelE","fuelF","grapes","apple","peach","banane","cerises","birne","battery","speedtrapdetector","fuelPipe"]]};
	...
	case "cop": {["Polizeiitemladen",["handcuffs","donuts","coffee","spikeStrip","water","rabbit","apple","redgull","fuelE","fuelF","speedtrap","laptop","battery","defusekit"]]};
	...
	case "rebel": {["Rebellenshop",["pille","handcuffs","pickaxe","fuelE","fuelF","water","redgull","tbacon","fuelManipulator","boltcutter","blastingcharge"]]};
