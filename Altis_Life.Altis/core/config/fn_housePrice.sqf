...
switch (_type) do
{
	...
	case "Land_i_House_Big_01_V1_F": {5000000};
	case "Land_i_House_Big_01_V2_F": {5000000};
	case "Land_i_House_Big_01_V3_F": {5000000};
	case "Land_i_House_Big_02_V1_F": {5000000};
	case "Land_i_House_Big_02_V2_F": {5000000};
	case "Land_i_House_Big_02_V3_F": {5000000};
	case "Land_i_Addon_02_V1_F": {3000000};
	case "Land_i_Addon_03_V1_F": {3000000};
	case "Land_i_Addon_03mid_V1": {3000000};
	case "Land_i_Addon_04_V1_F": {3000000};
