...
//[shortVar,reward]
life_illegal_items = [["heroinu",900],["heroinp",2400],["cocaine",2000],["cocainep",3500],["marijuana",2000],["methu",700],["methp",2200],["turtle",4200],["cannabis",500],["moonshine",1150],["uranu",3600],["uranp",5100],["frogs",250],["frogslsd",1000],["fuelManipulator",0],["blastingcharge",10000],["boltcutter",500]];
life_illegal_item_shortnames = ["heroinu","heroinp","cocaine","cocainep","cannabis","marijuana","turtle","methu","methp","moonshine",",uranu","uranp","frogs","frogslsd","fuelManipulator","blastingcharge","boltcutter"];
...
["safezone_kavalla","Kavalla",civilian,250,true],
["safezone_schiesstand","Schiesstand",civilian,175,true],
["safezone_knast","Knast",civilian,25,true]
];
