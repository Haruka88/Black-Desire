...
switch (playerSide) do
{
    case west:
    {
        ...
        ' !isNull cursorTarget && (player distance cursorTarget) < 5 && speed cursorTarget < 2 && (cursorTarget getVariable ["life_locked", 1] == 0) && (cursorTarget isKindOf "Land_i_House_Small_01_V1_F" || cursorTarget isKindOf "Land_i_House_Small_01_V2_F" || cursorTarget isKindOf "Land_i_House_Small_01_V3_F" || cursorTarget isKindOf "Land_i_House_Small_02_V1_F" || cursorTarget isKindOf "Land_i_House_Small_02_V2_F" || cursorTarget isKindOf "Land_i_House_Small_02_V3_F" || cursorTarget isKindOf "Land_i_House_Small_03_V1_F" || cursorTarget isKindOf "Land_i_House_Big_01_V1_F" || cursorTarget isKindOf "Land_i_House_Big_01_V2_F" || cursorTarget isKindOf "Land_i_House_Big_01_V3_F" || cursorTarget isKindOf "Land_i_House_Big_02_V1_F" || cursorTarget isKindOf "Land_i_House_Big_02_V2_F" || cursorTarget isKindOf "Land_i_House_Big_02_V3_F") && !life_action_inUse']];
		 ...
		 //Speedtrap
        life_actions = life_actions + [player addAction["<t color='#FF0000'>Einschalten</t>",king_fnc_speedtrapActivate,cursorTarget,10,false,false,"",
        ...
        life_actions = life_actions + [player addAction["<t color='#FF0000'>Ausschalten</t>",king_fnc_speedtrapActivate,cursorTarget,10,false,false,"",
        '!isNull cursorTarget && (player distance cursorTarget) < 20 && (cursorTarget isKindOf "Land_Runway_PAPI_4") && (cursorTarget getVariable["speedtrap_active", false]) && (cursorTarget getVariable["speedtrap_registered", false]) ']];
        
        life_actions = life_actions + [player addAction["<t color='#FF0000'>Film rausholen</t>",king_fnc_speedtrapGetPhotoList,1,10,false,false,"",
        ...
        life_actions = life_actions + [player addAction["<t color='#FF0000'>Daten anschauen</t>",king_fnc_speedtrapGetPhotoList,0,10,false,false,"",
        '!isNull cursorTarget && (player distance cursorTarget) < 20 && (cursorTarget isKindOf "Land_Runway_PAPI_4") && (cursorTarget getVariable["speedtrap_registered", false]) ']];
        
        life_actions = life_actions + [player addAction["<t color='#FF0000'>Geschwindigkeit setzen</t>",king_fnc_speedtrapSetSpeedLimit,cursorTarget,10,false,false,"",
        '!isNull cursorTarget && (player distance cursorTarget) < 20 && (cursorTarget isKindOf "Land_Runway_PAPI_4") && (cursorTarget getVariable["speedtrap_registered", false]) ']];

        life_actions = life_actions + [player addAction["<t color='#FF0000'>Abbauen</t>",king_fnc_speedtrapRemove,cursorTarget,10,false,false,"",
        '!isNull cursorTarget && (player distance cursorTarget) < 20 && (cursorTarget isKindOf "Land_Runway_PAPI_4") && (cursorTarget getVariable["speedtrap_registered", false]) ']];
    ...
    case civilian:
    {
		...
		//Speedtrap hacking
        life_actions = life_actions + [player addAction["<t color='#FF0000'>Daten hacken</t>",king_fnc_speedtrapHack,0,10,false,false,"",
        '!isNull cursorTarget && (player distance cursorTarget) < 20 && (cursorTarget isKindOf "Land_Runway_PAPI_4") && (cursorTarget getVariable["speedtrap_registered", false]) ']];
	};
};

//JailWork
life_actions = life_actions + [player addAction["<t color='#00FF00'>Steine sammeln</t>",king_fnc_jailWorkGather,1,10,true,true,"",'!isNull cursorTarget && (player distance cursorTarget) < 5 && (cursorTarget isKindOf "Land_AncientPillar_fallen_F") && (cursorTarget getVariable["king_jail_work_source_registered", false])']];
life_actions = life_actions + [player addAction["<t color='#00FF00'>Steine ablegen</t>",king_fnc_jailWorkDrop,1,10,true,true,"",'!isNull cursorTarget && (player distance cursorTarget) < 5 && (cursorTarget isKindOf "Land_CratesWooden_F") && (cursorTarget getVariable["king_jail_work_destination_registered", false])']];