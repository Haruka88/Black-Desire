...
switch(__GETC__(life_coplevel)) do
{
	...
	case 6: {life_paycheck = life_paycheck + 3800;};
...
while {(uniform player) == "U_B_SpecopsUniform_sgg"} do
	...
	switch (__GETC__(life_coplevel)) do 
		{
			case 4: {
			player setObjectTextureGlobal [0,"images\bka.jpg"];
			};
...
while {(uniform player) == "U_B_CombatUniform_mcam"} do
	...
	switch (__GETC__(life_coplevel)) do 
		{
			case 6: {
			player setObjectTextureGlobal [0,"images\coach.jpg"];
			};
...
private["_getRank"];
_getRank = switch (__GETC__(life_coplevel)) do {case 1: {1}; case 2: {2}; case 3: {3}; case 4: {4}; case 5: {5}; case 6: {6}; case 7: {7}; case 8: {8}; case 9: {9}; case 10: {10}; default {0};};
